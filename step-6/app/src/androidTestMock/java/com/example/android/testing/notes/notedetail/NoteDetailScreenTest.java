...
public class NoteDetailScreenTest {
    ...
    public void noteDetails_DisplayedInUi() throws Exception {
         ...
         * android.support.test.espresso.base.DefaultFailureHandler$AssertionFailedWithCauseError: 'with text: is "ATSL"' doesn't match the selected view.
         ...
         Got: "AppCompatTextView{id=2131492990, res-name=note_detail_title, visibility=VISIBLE, width=0, height=44, has-focus=false, has-focusable=false, has-window-focus=true, is-clickable=false, is-enabled=true, is-focused=false, is-focusable=false, is-layout-requested=false, is-selected=false, root-is-layout-requested=false, has-input-connection=false, x=24.0, y=216.0, text=, input-type=0, ime-target=false, has-links=false}"
