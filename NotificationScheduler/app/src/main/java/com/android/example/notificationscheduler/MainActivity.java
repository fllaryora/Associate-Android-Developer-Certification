...
public class MainActivity extends AppCompatActivity {
    ...
    //Run in the main thread (Seriously!)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Step 1 Get job scheduler instance
     ...
     */
    //In the Layout there is the onClick listener.
    public void scheduleJob(View view) {
        ...
        //Step 2 A
        // Put the whole work in a class ex. NotificationJobService
        ...
        if (seekBarSet) {
            //if you want to have a deadline (seekBarSet is true in this case),
            // call setOverrideDeadline(miliseconds)
            builder.setOverrideDeadline(seekBarInteger * 1000);
        }

        //completely unnecessary logic... it just want to have some constraints in the middle
